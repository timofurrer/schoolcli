  ...
  def cmd_cd( self, item, args, rawline ):
    ...
    if args == "" or args == "/":
      ...
      if args in school_names:
        ...
        print( Colorful.bold_red( "Could not change location because the school with the name `{}` could not be found".format( args ) ) )
      ...
      if args in term_names:
        ...
        print( Colorful.bold_red( "Could not change location because the term with the name `{}` could not be found in school `{}`".format( args, CLI.GetLocationValue( self ).Name ) ) )
    elif location == "term":
      ...
      if args in subject_shortcuts:
        ...
        print( Colorful.bold_red( "Could not change location because the subject with the shortcut `{}` could not be found in term `{}`".format( args, CLI.GetLocationValue( self ).Name ) ) )
